...
public interface ReservaVuelos {
    ...
    void actualizarVuelo(int id_pasajero,Integer nro_vuelo);//actualiza el vuelvo de una reserva especifica
    ...
    void reservaPorVuelo(int nro_vuelvo);//devuelve una ColaTDA de reservas de un vuelo especifico
